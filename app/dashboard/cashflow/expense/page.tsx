...
import { EXPENSE_CATEGORIES } from '@/lib';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || 'Gagal menambah pengeluaran');
      }
    } catch (err: any) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Catat Pengeluaran</h1>
        <p className="text-gray-600 dark:text-gray-400">Tambah transaksi pengeluaran baru</p>
      </div>
